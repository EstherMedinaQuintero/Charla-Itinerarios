...
class ButtonController {
     ...
     */
    constructor(game, deckContainerId, playersContainerId) {
        this.handViews = [];
        this.playersContainer = document.getElementById(playersContainerId);
    ...
    initializeButtons(game) {
        let dealHand1Button = document.getElementById('deal-hand1');
        let dealHand2Button = document.getElementById('deal-hand2');
